			...
			<Head>
				...
				{defaultOgImage?.url && (
					<>
						...
						{defaultOgImage.type && <meta property="og:image:type" content={defaultOgImage.type} />}
					</>
				)}
