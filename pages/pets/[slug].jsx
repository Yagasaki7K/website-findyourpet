	...
	return (
		<>
			<Head>
				...
				{pet?.description && <meta name="description" content={pet.description} />}
				<link rel="canonical" href={canonical} />
				<meta property="og:type" content="article" />
				<meta property="og:title" content={pageTitle} />
				{pet?.description && <meta property="og:description" content={pet.description} />}
				<meta property="og:url" content={canonical} />
				<meta property="og:image" content={ogImage} />
				<meta property="og:site_name" content="FindYourPet" />
				<meta name="twitter:card" content="summary_large_image" />
				<meta name="twitter:title" content={pageTitle} />
				{pet?.description && <meta name="twitter:description" content={pet.description} />}
